...
export const AnalysisResult: React.FC<AnalysisResultProps> = ({ analysis, originalText, webhookStatus }) => {
    ...
    <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden mt-8 animate-fade-in-up">
      ...
      <div className="p-6 border-b border-gray-100 bg-gray-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-medium">Categoría Detectada</p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-1">
            <div className={`px-4 py-2 rounded-lg font-bold shadow-sm flex items-center gap-2 ${getUrgencyColor(analysis.urgency_level)}`}>
              <span>Urgencia: {analysis.urgency_level}/5</span>
            </div>
      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="col-span-1 md:col-span-2">
          <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Resumen de Acción</label>
        ...
        <div className="col-span-1 md:col-span-2">
           <div className="flex justify-between items-end mb-1">
             <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Respuesta Sugerida</label>
             <button 
                id="copy-btn"
        ...
        <div className="col-span-1 md:col-span-2 mt-2 pt-4 border-t border-gray-100">
            <details className="text-xs text-gray-400 cursor-pointer w-full">
                <summary className="hover:text-gray-600 transition-colors">Ver datos técnicos</summary>
